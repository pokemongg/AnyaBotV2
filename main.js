...
async function connectionUpdate(update) {
  ...
  if (update.receivedPendingNotifications) conn.sendMessage(`6281261973803@s.whatsapp.net`, {text: 'BERHASIL TERSAMBUNG KE BOT ✿*Anya-Bot-v2*✿' })
}
