...
let handler = async (m, { conn }) => {
  ...
  let arietube = '6281261973803@s.whatsapp.net'
  let a = await conn.profilePictureUrl(conn.user.jid, 'image').catch((_) => "https://telegra.ph/file/c03ec512d671c3e26727b.jpg")
  let b = await conn.profilePictureUrl(owner[0]+'@s.whatsapp.net', 'image').catch((_) => "https://telegra.ph/file/c03ec512d671c3e26727b.jpg")
